...
@Entity
@Table(name = "fitness_metrics_history")
public class UserFitnessMetricsHistory {


    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long fitnessMetricHistoryId;
    ...
    public UserFitnessMetricsHistory() {
    }
    ...
    public Long getFitnessMetricHistoryId() {
        return fitnessMetricHistoryId;
    }

    public void setFitnessMetricHistoryId(Long fitnessMetricHistoryId) {
        this.fitnessMetricHistoryId = fitnessMetricHistoryId;
    }
